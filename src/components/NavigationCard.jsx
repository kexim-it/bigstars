...
import PigImage from "@/app/assets/images/swine/piglet-1.jpg";
    ...
    >
      <div className="flex flex-col lg:flex-row items-center justify-between gap-8">
        <div className="w-full ">
          <h3 className="text-2xl md:text-3xl font-semibold text-[var(--blue)]">
            Navigations
          </h3>
          {/* Left: Links + Image */}
          <div className="flex flex-col md:flex-row items-start gap-6 w-full my-10 ">
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-x-32 gap-y-4">
        ...
        <div className="w-full lg:w-2/3 space-y-4">
          <div className="w-full h-52 rounded-xl overflow-hidden">
            <Image
              alt="Piglet image representing swine feed options"
              src={PigImage}
